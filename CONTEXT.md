...
**Component catalog**:
Styled headless GPUI controls and reusable larger desktop components. GPUI Kit supplies the shared runtime and foundation; Kit controls and caller-owned state supply input and interaction behavior. A larger component may compose existing controls or add a missing reusable interaction; it must keep application data, routing and domain operations caller-owned.
